...
public class HuffmanEncoder {
	...
	private MinPriorityQByHeap<HuffmanTree> huffmanForest() {
		return this._HuffmanForest;
	}

	private void setHuffmanForest(MinPriorityQByHeap<HuffmanTree> newHuffmanForest) {
	...
	public short[][] serializedHuffmanTree() {
		return this._serialiszedHuffmanTree;
	}

	private void setSerializedHuffmanTree(short[][] newSerializedHuffmanTree) {
		this._serialiszedHuffmanTree = newSerializedHuffmanTree;
	}
	...
	private HuffmanTree buildHuffmanTree() {
		...
		while (this.huffmanForest().size() > 1) {
			HuffmanTree firstMinTree = this.huffmanForest().reomoveMin();
			HuffmanTree secondMinTree = this.huffmanForest().reomoveMin();
			this.huffmanForest().add(new HuffmanTree(firstMinTree, secondMinTree));
		}
		return this.huffmanForest().reomoveMin();
	}
